...
const addressHtml = (order) => {
  ...
  return `
    ...
    Pincode: ${escapeHtml(address.postalCode || address.pincode || "")}
  `;
};
...
<p>
  Thank you for your order. We have successfully received it.
</p>
...
<th style="text-align:left;padding:12px;background:#f3f4f6;">
  Product
</th>

<th style="padding:12px;background:#f3f4f6;">
  Qty
</th>

<th style="text-align:right;padding:12px;background:#f3f4f6;">
  Amount
</th>
